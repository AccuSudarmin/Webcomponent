(function() {
   var azselectajax = Object.create(HTMLSelectElement.prototype);

   azselectajax.createdCallback = function () {
      ...
      this.activateSubmit = function () {
         ...
         this.addEventListener(this.Method , function (e) {
            e = e || window.event;
   ...
   azselectajax.attachedCallback = function() {
      this.activateSubmit();
   }

   document.registerElement('az-selectajax', {
      prototype: azselectajax ,
      extends: 'select'
   });
})();
